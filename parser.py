...
def ad_passes_filters(data: dict, cfg: AppConfig) -> bool:
        ...
        for txt_file in txt_files:
            ...
            for url in urls:
                ...
                for ad_url, idphone in pairs:
                    ...
                    if ad_passes_filters(data, cfg):
                        db.insert_ad_if_new(data)
                        log_callback(f"Добавлено в БД: {ad_url}")
                    else:
                        log_callback(f"Не прошло фильтры: {ad_url}")
